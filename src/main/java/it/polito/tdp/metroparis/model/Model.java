...
//		System.out.println(this.grafo) ;
		...
		*/
		...
		public List <Fermata> fermateRaggiungibili (Fermata partenza){
			...
			bfv.addTraversalListener(new TraversalListener<Fermata, DefaultEdge>(){
				...
				//	Fermata precedente = vertice adiacente a 'nuova' che sia già raggiunto 
										// (cioè che è già presente nelle Key della mappa)
			...
			while(bfv.hasNext()) { //finchè hasNext() è vero --> ci sono nuovi vertici da scoprire
				Fermata f = bfv.next();
				result.add(f);
		...
		public List <Fermata> trovaCammino (Fermata partenza, Fermata arrivo){
			...
			return result; //risultato mi darà lista che contiene tutte le fermate
			//dall'arrivo alla partenza sul cammino minimo(cioè che fanno parte
			//dell'albero di cmamino minimo)
